"""Platform admin — Overview dashboard metrics."""
...
from app.services.platform_admin_metrics import build_overview_payload
...
def _require_super_admin(admin: PlatformAdmin) -> None:
    ...
    if admin.role != PlatformAdminRole.SUPER_ADMIN.value:
        raise HTTPException(
            ...
            detail="Only Super Admin can view platform overview",
        )
...
async def get_platform_overview(
    ...
    return await build_overview_payload(db)
